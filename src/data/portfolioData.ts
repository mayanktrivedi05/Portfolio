  ...
  experiences: [
    {
      ...
      type: "Internship",
      bullets: [
        "Engineered an enterprise Community Discussion Forum Platform using Laravel, PHP, MySQL, and Tailwind CSS, implementing multi-guard authentication, role-based access control (Admin/User), and user dashboards.",
        "Developed modular backend services including reusable FileUpload Traits for secure media processing, password encryption pipelines, and flash notification middleware.",
        "Integrated LLM-powered workflows and optimized RESTful APIs with Redis caching, boosting response speed by 35% and streamlining client context retrieval.",
        "Implemented Razorpay payment gateway integration for secure transaction processing within the platform.",
      ],
      skills: [
        "Laravel",
        "PHP",
